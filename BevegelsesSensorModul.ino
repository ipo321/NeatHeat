...
void loop() {
  ...
  if(millis() > nesteTom){ //her bruker vi samme prinsipp som med nesteSjekk. 
    ...
    bufferMillis = millis() + 1050;//formålet med bufferMills er at etter vi har tømmt radioen, gir vi NRF motakeren tid til å motta ett nytt signal hvis flammen fortsatt er tent.
