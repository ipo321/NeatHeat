...
//hvis den ikke ser en flamme vil den slutte å sende ut signaler.
...
//IR sensoren verdier ligger sirka på 25 og 300 den registrerer en flamme. Når den ikke registrerer flamme ligger den mellom 800 og 1000. 
...
void loop() {//dette er hoved loopen som kjøres når arduinoen er påslått. 
  ...
  delay(1000);  //delayer arduinoen i 1 sekund. intervallen for å sjekke flamme blir da 1 sekunder, om det er flammer blir intervallet på signal senidngene være 1 pr sekund.
